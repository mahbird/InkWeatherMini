...
No usage data is collected by InkWeatherMini. Information is fetched directly with hosts open API providers / NTP providers. All interactions are limited to the required calls directly made to service providers. Your WiFi information is stored directly in your device. If you flashes the ready-to-use ".bin" files, please use "/clearNVS" on settings menu to clear your saved settings. 
